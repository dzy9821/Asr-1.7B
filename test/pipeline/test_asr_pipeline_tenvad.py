...
import asr_pipeline_tenvad as pipeline_module


class TestASRPipelineTenVAD(unittest.TestCase):
    def test_main_uses_ten_vad(self):
        with patch.object(pipeline_module, "TenVADWrapper") as mock_vad_cls, patch.object(
