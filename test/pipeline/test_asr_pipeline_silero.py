...
import asr_pipeline_silero as pipeline_module


class TestASRPipelineSilero(unittest.TestCase):
    def test_main_uses_silero_vad(self):
        with patch.object(pipeline_module, "SileroVAD") as mock_vad_cls, patch.object(
